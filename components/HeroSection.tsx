    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      <div className="text-center space-y-8">
        <div className="space-y-6">
          ...
          <p className="text-xl lg:text-2xl text-zinc-300 max-w-4xl mx-auto leading-relaxed">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          <div className="relative group">
            ...
            <div className="relative px-8 py-6 bg-zinc-900 border border-zinc-700 rounded-xl">
              <div className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">
                33%
              </div>
              <div className="text-sm text-zinc-400 font-medium">COST SAVED</div>
            </div>
          </div>
          <div className="relative group">
            ...
            <div className="relative px-8 py-6 bg-zinc-900 border border-zinc-700 rounded-xl">
              ...
              <div className="text-sm text-zinc-400 font-medium">TIME SAVED</div>
            </div>
          </div>
          <div className="relative group">
            ...
            <div className="relative px-8 py-6 bg-zinc-900 border border-zinc-700 rounded-xl">
              ...
              <div className="text-sm text-zinc-400 font-medium">LESS RESOURCES</div>
            </div>
          </div>
        </div>
